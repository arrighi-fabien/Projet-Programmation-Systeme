...
namespace CryptoSoft {
    internal class Program {
        ...
        /// </summary>
        /// <param name="args">The first argument is the source file and the second argument is the destination file</param>
        ...
        static int Main(string[] args) {
            ...
            try {
                ...
                byte[] key = Encoding.UTF8.GetBytes("2784070415730864970");
        ...
        static byte[] EncryptData(byte[] data, byte[] key) {
            ...
            Parallel.For(0, threads, i => {
                ...
                byte[] partition = new byte[end - start];

                for (int j = start; j < end; j++) {
                    partition[j - start] = (byte)(data[j] ^ key[j % key.Length]);
                }
            });
